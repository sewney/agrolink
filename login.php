                    ...
                    <div class="container">
                        <div class="form-container">
                            ...
                            <div class="text-center mt-lg">
                                <p>Don't have an account? <a href="#register" data-modal="registerModal" class="text-primary">Register here</a></p>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="grid grid-3 mt-lg">
                                <a href="register_farmer.php" class="card text-center" style="text-decoration: none;">
                                    <div class="card-icon"></div>
                                    <h4>Farmer</h4>
                                    <p>List and sell your produce</p>
                                </a>
                                <a href="register_buyer.php" class="card text-center" style="text-decoration: none;">
                                    <div class="card-icon">🛒</div>
                                    <h4>Buyer</h4>
                                    <p>Purchase fresh produce</p>
                                </a>
                                <a href="register_transporter.php" class="card text-center" style="text-decoration: none;">
                                    <div class="card-icon">🚚</div>
                                    <h4>Transporter</h4>
