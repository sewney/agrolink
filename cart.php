...
<body>
    ...
    <section class="section bg-light" style="padding: var(--spacing-lg) 0;">
        <div class="container">
            <h1 class="section-title" style="margin-bottom: var(--spacing-sm);">🛒 Your Shopping Cart</h1>
                    ...
                    <div class="card mt-lg">
                        <div style="padding: var(--spacing-lg);">
                            ...
                            <ul style="margin-top: var(--spacing-md); color: var(--dark-gray); font-size: 0.9rem;">
                                <li style="margin-bottom: var(--spacing-xs);">• Free delivery for orders over Rs. 2,500</li>
                                <li style="margin-bottom: var(--spacing-xs);">• Delivery within 1-3 business days</li>
                                <li style="margin-bottom: var(--spacing-xs);">• Fresh produce guaranteed</li>
                                <li style="margin-bottom: var(--spacing-xs);">• Contact farmer directly for special requests</li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="product-grid" style="grid-template-columns: repeat(auto-fit, minmax(250px, 1fr));">
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <div class="product-farmer">👨‍🌾 Kamal Perera</div>
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <div class="product-farmer">👩‍🌾 Nirmala Silva</div>
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <div class="product-farmer">👨‍🌾 Bandara Wickrama</div>
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <div class="product-location">📍 Nuwara Eliya</div>
                        <div class="product-farmer">👩‍🌾 Sujatha Fernando</div>
        ...
        function renderCartItems() {
            ...
            cartContainer.innerHTML = cart.map(item => `
                <div class="cart-item" style="display: flex; align-items: center; gap: var(--spacing-md); padding: var(--spacing-md); border: 1px solid var(--medium-gray); border-radius: var(--radius-md); margin-bottom: var(--spacing-md);">
                    ...
                    <button class="remove-item" data-product-id="${item.id}" style="background: #f44336; color: white; border: none; border-radius: var(--radius-sm); padding: var(--spacing-xs); cursor: pointer; margin-left: var(--spacing-sm);">🗑️</button>
                </div>
            `).join('');
