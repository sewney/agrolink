...
<body>
    ...
    <header class="header">
        <nav class="nav container">
            ...
            <div class="nav-actions">
                <div class="user-info">
                    <span>Welcome, <span id="transporterName">Transporter</span></span>
    ...
    <div class="dashboard">
        <!-- Sidebar -->
        <aside class="sidebar">
            <h3 style="margin-bottom: var(--spacing-lg); color: var(--primary-green);">🚚 Transporter Dashboard</h3>
            <ul class="sidebar-menu">
                <li><a href="#dashboard" class="menu-link active" data-section="dashboard">📊 Dashboard</a></li>
                <li><a href="#available" class="menu-link" data-section="available">📋 Available Deliveries</a></li>
                <li><a href="#mydeliveries" class="menu-link" data-section="mydeliveries">🚛 My Deliveries</a></li>
                <li><a href="#schedule" class="menu-link" data-section="schedule">📅 Schedule</a></li>
                <li><a href="#earnings" class="menu-link" data-section="earnings">💰 Earnings</a></li>
                <li><a href="#vehicle" class="menu-link" data-section="vehicle">🚗 Vehicle Management</a></li>
                <li><a href="#profile" class="menu-link" data-section="profile">👤 Profile</a></li>
