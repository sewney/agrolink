                ...
                <div>
                    ...
                    <div class="card mt-lg">
                        <div style="padding: var(--spacing-lg);">
                            ...
                            <ul style="margin-top: var(--spacing-md); color: var(--dark-gray); font-size: 0.9rem;">
                                <li style="margin-bottom: var(--spacing-xs);">• SSL encrypted transaction</li>
                                <li style="margin-bottom: var(--spacing-xs);">• Your data is protected</li>
                                <li style="margin-bottom: var(--spacing-xs);">• Demo mode - no real payment</li>
                                <li style="margin-bottom: var(--spacing-xs);">• 100% satisfaction guarantee</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="card mt-lg">
                        <div style="padding: var(--spacing-lg);">
                            ...
                            <div style="margin-top: var(--spacing-md);">
                                <p style="font-size: 0.9rem;"><strong>📞 Phone:</strong> +94 xxx xxx xxx</p>
                                <p style="font-size: 0.9rem;"><strong>📧 Email:</strong> support@agrolink.lk</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: var(--spacing-md); padding-bottom: var(--spacing-md); border-bottom: 1px solid var(--light-gray);">
                    <div style="display: flex; align-items: center; gap: var(--spacing-sm);">
                        ...
                        <div>
                            ...
                            <div style="font-size: 0.8rem; color: var(--dark-gray);">Rs. ${item.price}/kg × ${item.quantity}</div>
                        </div>
                    </div>
