                ...
                <div class="card" style="max-width: 600px; margin: 0 auto var(--spacing-xl);">
                    <div style="padding: var(--spacing-xl);">
                        ...
                        <div class="notification success">
                            ...
                            • Farmers will prepare your order<br>
                            • Delivery will be coordinated with transporters<br>
    ...
    <section class="section">
        <div class="container">
            <div class="card" style="max-width: 800px; margin: 0 auto;">
                <div style="padding: var(--spacing-xl); text-center;">
                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: var(--spacing-sm); padding-bottom: var(--spacing-sm); border-bottom: 1px solid var(--light-gray);">
                            <div style="display: flex; align-items: center; gap: var(--spacing-sm);">
                                ...
                                <div>
                                    ...
                                    <div style="font-size: 0.9rem; color: var(--dark-gray);">Rs. ${item.price}/kg × ${item.quantity}</div>
                                </div>
                            </div>
