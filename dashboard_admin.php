...
<body>
    ...
    <div class="dashboard">
        <!-- Sidebar -->
        <aside class="sidebar">
            <h3 style="margin-bottom: var(--spacing-lg); color: var(--primary-green);">🛠️ Admin Dashboard</h3>
            <ul class="sidebar-menu">
                <li><a href="#dashboard" class="menu-link active" data-section="dashboard">📊 Dashboard</a></li>
                <li><a href="#users" class="menu-link" data-section="users">👥 User Management</a></li>
                <li><a href="#orders" class="menu-link" data-section="orders">📦 Order Management</a></li>
                <li><a href="#products" class="menu-link" data-section="products">🌾 Product Management</a></li>
                <li><a href="#payments" class="menu-link" data-section="payments">💳 Payments & Finance</a></li>
                <li><a href="#disputes" class="menu-link" data-section="disputes">⚖️ Disputes</a></li>
                <li><a href="#analytics" class="menu-link" data-section="analytics">📈 Analytics</a></li>
                <li><a href="#notifications" class="menu-link" data-section="notifications">📢 Notifications</a></li>
                <li><a href="#settings" class="menu-link" data-section="settings">⚙️ Settings</a></li>
            </ul>
        </aside>
            ...
            <div id="analytics-section" class="content-section" style="display: none;">
                ...
                <div class="grid grid-2" style="margin-top: var(--spacing-xl);">
                    <div class="card">
                        ...
                        <div style="padding: var(--spacing-xl); text-center; color: var(--dark-gray);">
