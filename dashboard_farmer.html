...
<body>
    ...
    <div class="dashboard">
        <!-- Sidebar -->
        <aside class="sidebar">
            <h3 style="margin-bottom: var(--spacing-lg); color: var(--primary-green);">🧑‍🌾 Farmer Dashboard</h3>
            <ul class="sidebar-menu">
                <li><a href="#dashboard" class="menu-link active" data-section="dashboard">📊 Dashboard</a></li>
                <li><a href="#products" class="menu-link" data-section="products">🌾 My Products</a></li>
                <li><a href="#orders" class="menu-link" data-section="orders">📦 Orders</a></li>
                <li><a href="#earnings" class="menu-link" data-section="earnings">💰 Earnings</a></li>
                <li><a href="#deliveries" class="menu-link" data-section="deliveries">🚚 Deliveries</a></li>
