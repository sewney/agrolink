...
<body>
    ...
    <header class="header">
        <nav class="nav container">
            <div class="logo">
                <img src="assets/img/Logo 2.svg" alt="AgroLink" style="height: 60px;">
            </div>
            <div class="nav-links">
                <a href="#home">Home</a>
    ...
    <!-- Hero Section -->
    <section id="home" class="hero" style="background: url('assets/img/hero-farm.jpg') center center/cover no-repeat; min-height: 500px; position: relative;">
        ...
        <div class="container">
            <div class="footer-content">
                <div class="footer-section">
                    <div class="logo">
                        <img src="assets/img/Logo 2.svg" alt="AgroLink" style="height: 50px;">
                    </div>
